...
std::pair<absl::Span<uint32_t>,
          absl::optional<ConfigurationPacket<Spartan3ConfigurationRegister>>>
ConfigurationPacket<Spartan3ConfigurationRegister>::InitWithWords(
    absl::Span<uint32_t> words,
    const ConfigurationPacket<Spartan3ConfigurationRegister> *previous_packet) {
  using ConfigurationRegister = Spartan3ConfigurationRegister;
...
template std::ostream & operator<<(
	std::ostream &,
    const ConfigurationPacket<Spartan3ConfigurationRegister> &);
template std::ostream& operator<<(
    std::ostream&,

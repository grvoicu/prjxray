#ifndef PRJXRAY_LIB_XILINX_SPARTAN3_ROW_H_
#define PRJXRAY_LIB_XILINX_SPARTAN3_ROW_H_
...
#include <prjxray/xilinx/spartan3/configuration_bus.h>
...
public:
  ...
  // The addresses may be noncontiguous and/or unsorted but all must
  ...
  // address components are considered as the remaining components are
...
namespace YAML {
template <> struct convert<prjxray::xilinx::spartan3::Row> {
  static Node encode(const prjxray::xilinx::spartan3::Row &rhs);
  static bool decode(const Node &node, prjxray::xilinx::spartan3::Row &lhs);
};
} // namespace YAML

#endif // PRJXRAY_LIB_XILINX_SPARTAN3_ROW_H_

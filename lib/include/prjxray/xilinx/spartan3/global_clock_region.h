#ifndef PRJXRAY_LIB_XILINX_SPARTAN3_GLOBAL_CLOCK_REGION_H_
#define PRJXRAY_LIB_XILINX_SPARTAN3_GLOBAL_CLOCK_REGION_H_
...
public:
  ...
  // noncontiguous and/or unordered but they must share the same row
...
namespace YAML {
template <> struct convert<prjxray::xilinx::spartan3::GlobalClockRegion> {
  static Node encode(const prjxray::xilinx::spartan3::GlobalClockRegion &rhs);
  static bool decode(const Node &node,
                     prjxray::xilinx::spartan3::GlobalClockRegion &lhs);
};
} // namespace YAML

#endif // PRJXRAY_LIB_XILINX_SPARTAN3_GLOBAL_CLOCK_REGION_H_

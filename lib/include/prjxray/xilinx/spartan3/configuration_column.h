#ifndef PRJXRAY_LIB_XILINX_SPARTAN3_CONFIGURATION_COLUMN_H_
#define PRJXRAY_LIB_XILINX_SPARTAN3_CONFIGURATION_COLUMN_H_
...
public:
  ...
  // Returns a ConfigurationColumn that describes a contiguous range of
  // minor addresses that encompasses the given FrameAddresses.
  // The provided addresses must only differ only by their minor addresses.
...
namespace YAML {
template <> struct convert<prjxray::xilinx::spartan3::ConfigurationColumn> {
  static Node encode(const prjxray::xilinx::spartan3::ConfigurationColumn &rhs);
  static bool decode(const Node &node,
                     prjxray::xilinx::spartan3::ConfigurationColumn &lhs);
};
} // namespace YAML

#endif // PRJXRAY_LIB_XILINX_SPARTAN3_CONFIGURATION_COLUMN_H_

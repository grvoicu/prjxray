#ifndef PRJXRAY_LIB_XILINX_SPARTAN3_CONFIGURATION_BUS_H_
#define PRJXRAY_LIB_XILINX_SPARTAN3_CONFIGURATION_BUS_H_
...
namespace YAML {
template <> struct convert<prjxray::xilinx::spartan3::ConfigurationBus> {
  static Node encode(const prjxray::xilinx::spartan3::ConfigurationBus &rhs);
  static bool decode(const Node &node,
                     prjxray::xilinx::spartan3::ConfigurationBus &lhs);
};
} // namespace YAML

#endif // PRJXRAY_LIB_XILINX_SPARTAN3_CONFIGURATION_BUS_H_
